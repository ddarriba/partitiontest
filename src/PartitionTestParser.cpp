...
namespace partest_parser
{
  ...
  int PartitionTestParser::parseConfigFile ()
  {
    ...
    switch (format)
      ...
      case cfPartitionFinder:
        {
          parserUtils.parsePartitionFinderFile (&partitionStrings, &alignment,
                                                &models, &searchAlgo,
                                                &icSelection);
          break;
        }
    ...
    switch (searchAlgo)
      ...
      case searchRCluster:
        ofs << "algorithm = hcluster" << endl << endl;
        ofs << "; *** search algorithm in original control file was RCluster"
            << endl;
        ofs
            << "; *** please select the number of replicates below according to your data"
            << endl;
